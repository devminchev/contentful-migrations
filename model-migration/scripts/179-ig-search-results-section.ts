...
export = (function (migration) {
    ...
    const igCarouselA = migration
        .createContentType('igSearchResults')
        .name('IG Search Results')
        .description('A section placeholder for the games search')
    ...
    const igCarouselAFields: { id: string; options: IFieldOptions }[] = [
        ...
        { id: 'classification', options: { name: 'Classification', type: 'Symbol', required: false, defaultValue: { [locale]: 'SearchResultsSection' }, validations: [{ in: ['SearchResultsSection'] }], disabled: true } }
    ];
    ...
    const fieldControls = [
        ...
        { id: 'classification', widget: 'singleLine', helpText: 'Layout type (fixed to CarouselSection)' }
    ];
