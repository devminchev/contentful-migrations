...
export const updateData = async (
    ...
    try {
        ...
        //update specific to unlinkWHGamesFromSection script
        const data = JSON.parse(await readFile(`./src/unlinkWHGamesFromSection/data/${old_model}/${spaceFolder}/${new_model}.json`, 'utf-8'));
