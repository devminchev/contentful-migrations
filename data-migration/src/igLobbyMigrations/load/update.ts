...
export const updateData = async (
    ...
    try {
        ...
        const data = JSON.parse(await readFile(`./src/igLobbyMigrations/data/${old_model}/${spaceFolder}/${new_model}.json`, 'utf-8'));
        ...
        if (failedEntries.length > 0) {
            await writeFile(
                `./src/igLobbyMigrations/data/${old_model}/${spaceFolder}/${new_model}-failed.json`,
