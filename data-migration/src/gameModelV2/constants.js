...
const CONTENT_TYPES = [
  { name: SITE_GAME, model: SITE_GAME, query: [] },
  { name: GAME, model: GAME, query: [] },
  { name: GAME_INFO, model: GAME_INFO, query: [] },
  { name: GAME_CONFIG, model: GAME_CONFIG, query: [] },
  { name: SECTION, model: SECTION, query: [] },
  { name: VENTURE, model: VENTURE, query: [] },
  {
    name: `${SITE_GAME}-mobile`,
    model: SITE_GAME,
    query: [`fields.entryTitle[match]="-m"`],
  },
];
